...
const Cart = () => {
    ...
    const { loading, paymentInstance } = useSelector(state => state.paymentReducer);
    ...
    const handlePaymentConfirmation = () => {
        ...
        dispatch(verifyPaymentAction(token, order, {}));
                        ...
                        <div style={{ marginLeft: "50px" }}>
                            ...
                            {user ? (
                                <button className="btn btn-danger" onClick={() => {
                                    ...
                                    <i style={{ marginRight: "5px" }} className="fas fa-shopping-cart" /> CHECKOUT
                                </button>
                            ) : (
                                <Link to="/login">
